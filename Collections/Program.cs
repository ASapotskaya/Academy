...
namespace Collections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //WriteLine($"Вместимость по умолчанию:{ arrayList1.Capacity} {arrayList1.Count}");
            ////2
            //ArrayList arrayList2 = new ArrayList(5);
            //WriteLine($"Вместимость :{ arrayList1.Capacity} {arrayList2.Count}");
            //3
            //ArrayList arrayList1 = new ArrayList();
            //arrayList1.Add("word");
            //WriteLine($"Вместимость после добавления одного элемента: { arrayList1.Capacity} {arrayList1.Count}");
            //////4
            ...
            //arrayList2.AddRange(new int[] { 1, 2, 3 });
            //WriteLine($"Вместимость :{ arrayList2.Capacity}");
            //System.Console.WriteLine("***************************************************");
            ////7

            //ArrayList arrayList3 = new ArrayList(7);
            //WriteLine($"Вместимость :{ arrayList3.Capacity}");
            //arrayList3.AddRange(new int[] { 1, 2, 3 });
            //WriteLine($"Вместимость :{ arrayList3.Capacity}");
            //arrayList3.TrimToSize();
            //WriteLine($"Вместимость уменьшена до реального  количества элементов: { arrayList3.Capacity}");
            ////8
            //ArrayList arrayList1 = new ArrayList(new int[] { 1, 2, 3 });
            //WriteLine($"Элемент с индексом 2: { arrayList1[2]} ");
            //9
            //ArrayList arrayList1 = new ArrayList(new string[] { "one", null , "two", null , "three", null });
            ...
            //    ArrayList only = new ArrayList(days.GetRange(5, 3));
            ...
            //System.Console.WriteLine("***********************************");
            ////14
            //ArrayList numbers2 = new ArrayList(new int[] { 1, 2, 3, 4, 5 });
            //numbers2.Sort();
